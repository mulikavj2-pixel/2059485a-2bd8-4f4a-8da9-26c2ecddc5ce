...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Experience exceptional coffee and warm community at Brew Haven",
    siteName: "Brew Haven",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766070579352-njr3ugz4.jpg",
  ...
  twitter: {
    ...
    description: "Freshly roasted specialty coffee and welcoming atmosphere",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766070579352-njr3ugz4.jpg"]
  },
  robots: {
    index: true,
    follow: true
